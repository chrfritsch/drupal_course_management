...
/**
 * Controller for handling exam receipt downloads.
 */
class ExamReceiptController extends ControllerBase {
  ...
  /**
   * Constructs a new ExamReceiptController object.
   */
  ...
  public function downloadPdf($receipt_id) {
    ...
    if (!$receipt || $receipt->bundle() !== 'exam_payment_receipt') {
